 ...
 * generated in the com.borabora.csws.client package.
...
public class ObjectFactory {
    ...
    private final static QName _C2F_QNAME = new QName("http://csws.borabora.com/", "c2f");
    private final static QName _F2CResponse_QNAME = new QName("http://csws.borabora.com/", "f2cResponse");
    private final static QName _C2FResponse_QNAME = new QName("http://csws.borabora.com/", "c2fResponse");
    private final static QName _F2C_QNAME = new QName("http://csws.borabora.com/", "f2c");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.borabora.csws.client
     */
     ...
     */
    @XmlElementDecl(namespace = "http://csws.borabora.com/", name = "c2f")
     ...
     */
    @XmlElementDecl(namespace = "http://csws.borabora.com/", name = "f2cResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://csws.borabora.com/", name = "c2fResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://csws.borabora.com/", name = "f2c")
